...
ax.vlines(timeSeries, bidPriceSeries - 0.0000001 * np.array(bidVolumeSeries) ** 2, bidPriceSeries, color = 'blue', label = "BID VOLUME")
ax.vlines(timeSeries, askPriceSeries, askPriceSeries + 0.0000001 * np.array(askVolumeSeries) ** 2, color = 'orange', label = "ASK VOLUME")
plt.legend()
plt.show()